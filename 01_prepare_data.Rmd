...
```{r prepare_data_libraries, warning=FALSE, comments="", message=FALSE}
library(tidyverse)
library(phyloseq)
```
...
## Gene annotation
```{r annotation, warning=FALSE, comments="", message=FALSE}
gene_annotations <- read_tsv("resources/kegg_merged.tsv")
```
