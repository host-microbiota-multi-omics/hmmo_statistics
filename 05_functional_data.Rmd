...
genome_counts_filt_func <- genome_counts_filt[genome_counts_filt$genome %in% rownames(genome_gifts_raw),]
...
```{r function_ordination, message=FALSE, fig.height=8, fig.width=14, fig.fullwidth=TRUE}
library(Rtsne)
